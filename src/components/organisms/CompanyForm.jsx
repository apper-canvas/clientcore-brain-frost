...
const CompanyForm = ({ isOpen, onClose, onCompanyCreated }) => {
  ...
  const validateForm = () => {
    ...
    if (formData.website_c && !/^https?:\/\/.+\..+/.test(formData.website_c)) {
      newErrors.website_c = 'Please enter a valid website URL (including http:// or https://)';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onCompanyCreated && onCompanyCreated(newCompany);
      handleClose();
    } catch (error) {
          ...
          <div className="flex items-center justify-between p-6 border-b border-slate-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Add a new company to your database</p>
              </div>
            </div>
            <Button
              variant="ghost"
          ...
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleInputChange('size_c', value)}
                    disabled={loading}
                  >
              ...
              <div>
                ...
                />
                {errors.website_c && (
                  <p className="mt-1 text-sm text-red-600">{errors.website_c}</p>
                )}
              </div>
